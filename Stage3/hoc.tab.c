...
{
       0,     0,     3,     4,     8,    11,    15,    19,    23,    26,
      30,    34,    38,    42,    46,    48,    50,    52,    54,    59,
...
{
      25,     0,    -1,    -1,    25,    10,    19,    -1,    25,    19,
      -1,    25,    26,    19,    -1,    25,     1,    19,    -1,    25,
      27,    19,    -1,    25,    20,    -1,    25,    26,    20,    -1,
      25,     1,    20,    -1,    25,    27,    20,    -1,     4,    11,
      27,    -1,     7,    11,    27,    -1,     3,    -1,     4,    -1,
       7,    -1,    26,    -1,     5,    21,    27,    22,    -1,     8,
      21,    27,    23,    27,    22,    -1,     9,    21,    22,    -1,
      27,    12,    27,    -1,    27,    13,    27,    -1,    27,    14,
      27,    -1,    27,    15,    27,    -1,    27,    16,    27,    -1,
      27,    18,    27,    -1,    21,    27,    22,    -1,    13,    27,
      -1
};
...
static const char *const yytname[] =
{
  ...
  "CNST", "BLTIN2", "BLTIN0", "SYS", "'='", "'+'", "'-'", "'*'", "'/'",
  "'%'", "UNARYMINUS", "'^'", "'\\n'", "';'", "'('", "')'", "','",
  "$accept", "list", "asgn", "expr", 0
};
#endif
...
{
       2,     0,     1,     0,    14,    15,     0,    16,     0,     0,
       0,     0,     4,     8,     0,    17,     0,     6,    10,     0,
       0,     0,     0,     0,     3,    17,    28,     0,     5,     9,
       0,     0,     0,     0,     0,     0,     7,    11,    12,     0,
      13,     0,    20,    27,    21,    22,    23,    24,    25,    26,
      18,     0,     0,    19
};
...
{
     -19,    25,   -19,   -18,   -19,    -5,   -14,     6,    10,    15,
       8,    44,   -19,   -19,    44,   -15,    91,   -19,   -19,    44,
      44,    44,    44,    17,   -19,   -19,    19,    58,   -19,   -19,
      44,    44,    44,    44,    44,    44,   -19,   -19,     0,    69,
       0,    46,   -19,   -19,    98,    98,    19,    19,    19,    19,
     -19,    44,    80,   -19
};
...
{
      26,    17,    18,    27,    28,    29,    19,    20,    38,    39,
      40,    41,    30,    31,    32,    33,    34,    21,    35,    44,
      45,    46,    47,    48,    49,     2,     3,    24,     4,     5,
       6,    22,     7,     8,     9,    10,    23,    35,    11,    42,
      52,    15,     0,     0,    12,    13,    14,     4,     5,     6,
       0,     7,     8,     9,     0,     0,     0,    11,    30,    31,
      32,    33,    34,     0,    35,    14,     0,     0,     0,    51,
      30,    31,    32,    33,    34,     0,    35,     0,     0,     0,
      43,    30,    31,    32,    33,    34,     0,    35,     0,     0,
       0,    50,    30,    31,    32,    33,    34,     0,    35,     0,
       0,     0,    53,    30,    31,    32,    33,    34,     0,    35,
      36,    37,    32,    33,    34,     0,    35
};

static const yytype_int8 yycheck[] =
{
      11,    19,    20,    14,    19,    20,    11,    21,    19,    20,
      21,    22,    12,    13,    14,    15,    16,    11,    18,    30,
      31,    32,    33,    34,    35,     0,     1,    19,     3,     4,
       5,    21,     7,     8,     9,    10,    21,    18,    13,    22,
      51,     1,    -1,    -1,    19,    20,    21,     3,     4,     5,
      -1,     7,     8,     9,    -1,    -1,    -1,    13,    12,    13,
      14,    15,    16,    -1,    18,    21,    -1,    -1,    -1,    23,
...
{
       0,    25,     0,     1,     3,     4,     5,     7,     8,     9,
      10,    13,    19,    20,    21,    26,    27,    19,    20,    11,
      21,    11,    21,    21,    19,    26,    27,    27,    19,    20,
      12,    13,    14,    15,    16,    18,    19,    20,    27,    27,
      27,    27,    22,    22,    27,    27,    27,    27,    27,    27,
      22,    23,    27,    22
};
...
#line 63 "hoc.y"
  ...
  case 15:
#line 66 "hoc.y"
    {if((yyvsp[(1) - (1)].sym)->type == UNDEF) execerror("undefined variable",(yyvsp[(1) - (1)].sym)->name); (yyval.val) = (yyvsp[(1) - (1)].sym)->u.val; ;}
    break;
...
#line 67 "hoc.y"
  ...
  case 18:
#line 69 "hoc.y"
    {(yyval.val) = dispatch((yyvsp[(3) - (4)].val),0,(yyvsp[(1) - (4)].sym)->name); ;}
    break;

  case 19:
#line 70 "hoc.y"
    {(yyval.val) = dispatch((yyvsp[(3) - (6)].val),(yyvsp[(5) - (6)].val),(yyvsp[(1) - (6)].sym)->name); ;}
    break;

  case 20:
#line 71 "hoc.y"
    {(yyval.val) = dispatch(0,0,(yyvsp[(1) - (3)].sym)->name); ;}
    break;
...
#line 74 "hoc.y"
  ...
  case 24:
#line 75 "hoc.y"
    {if((yyvsp[(3) - (3)].val) == 0) execerror("cant divide by zero",""); (yyval.val) = (yyvsp[(1) - (3)].val) / (yyvsp[(3) - (3)].val); ;}
    break;

  case 25:
#line 76 "hoc.y"
    {if((yyvsp[(3) - (3)].val) == 0) execerror("cant divide by zero",""); (yyval.val) = (int)(yyvsp[(1) - (3)].val) % (int)(yyvsp[(3) - (3)].val); ;}
    break;
